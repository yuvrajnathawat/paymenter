...
<head>
    ...
    @endif
    @isset($title)
    <meta content="{{ isset($title) ? config('app.name', 'Bazzar') . ' - ' . $title : config('app.name', 'Bazzar') }}" property="og:title">
    <meta content="{{ isset($title) ? config('app.name', 'Bazzar') . ' - ' . $title : config('app.name', 'Bazzar') }}" name="title">
    @endisset
    @isset($description)
